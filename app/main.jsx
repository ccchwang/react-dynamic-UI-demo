...
import { HeroVideo, Jumbotron, JumbotronCol, HoverRow, HoverCol, DrawerContainer, MenuItem, Navbar, NavItem, Nav, Button } from 'react-dynamic-ui';
...
render(
  ...
  <Jumbotron>
    ...
    >
      <img src="./images/graphic-waves.png" className="waves-graphic" />
    </JumbotronCol>
   </Jumbotron>
  ...
  <HoverRow className="hover-row1">
    <HoverCol imgSrc="./images/waves1.png" />
    <HoverCol imgSrc="./images/waves7.png" />
  </HoverRow>

  <HoverRow className="hover-row2">
    <HoverCol imgSrc="./images/waves3.png" />
    <HoverCol imgSrc="./images/waves4.png" />
    <HoverCol imgSrc="./images/waves9.png" />
  </HoverRow>
    ...
    <JumbotronCol className="jumbo-fadeUp right img">
      <img src="./images/waves8.png" className="waves-graphic"/>
    </JumbotronCol>
   </Jumbotron>
